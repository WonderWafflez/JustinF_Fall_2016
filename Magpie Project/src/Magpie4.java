public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		} else if (findKeyword(statement, "Mrs.Peel") >= 0
				|| findKeyword(statement, "Mrs. Dreyer") >= 0
				|| findKeyword(statement, "Mr. Lira") >= 0
				|| findKeyword(statement, "Mrs. Dwyer") >= 0
				|| findKeyword(statement, "Mrs. Cotter") >= 0
				|| findKeyword(statement, "Mrs. Ronina") >= 0) {
			response = "Wow!!! Awesome teacher!!!";
